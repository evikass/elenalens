...
const defaultShots: ShotMeta[] = [
  ...
  { src: `${basePath}/work-54.jpg`, filename: 'work-54.jpg', title: 'Осенние листья в парке', cat: 'Портрет' },
  { src: `${basePath}/work-55.jpg`, filename: 'work-55.jpg', title: 'У кирпичной стены', cat: 'Портрет' },
  { src: `${basePath}/work-56.jpg`, filename: 'work-56.jpg', title: 'В берете с листьями', cat: 'Портрет' },
  { src: `${basePath}/work-57.jpg`, filename: 'work-57.jpg', title: 'С осенними листьями', cat: 'Портрет' },
  { src: `${basePath}/work-58.jpg`, filename: 'work-58.jpg', title: 'У кирпича на набережной', cat: 'Портрет' },
  { src: `${basePath}/work-59.jpg`, filename: 'work-59.jpg', title: 'На ограждении в берете', cat: 'Портрет' },
  { src: `${basePath}/work-60.jpg`, filename: 'work-60.jpg', title: 'С листьями в лесу', cat: 'Портрет' },
  { src: `${basePath}/work-61.jpg`, filename: 'work-61.jpg', title: 'В прыжке на аллее', cat: 'Портрет' },
  { src: `${basePath}/work-62.jpg`, filename: 'work-62.jpg', title: 'На ограждении в парке', cat: 'Портрет' },
]
