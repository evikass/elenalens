        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              ...
              <p>
                Работаю в Нижнем Новгороде и Кирове (Вятке), выезжаю на
                локации по всему региону, принимаю у себя в студии. Со мной
                спокойно — я знаю, как поставить даже самого «нефотогеничного»
                клиента, и в итоге он удивляется своему портрету.
              </p>
            </div>
